...
public class ApplicationSecurityConfiguration {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        ...
        RegisteredClient clientCredentialClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .scopes(scopeConfig -> scopeConfig.addAll(Set.of(OidcScopes.OPENID, "ADMIN", "USER")))
        ...
        RegisteredClient opaqueTokenClient = RegisteredClient.withId(UUID.randomUUID().toString())
        ...
        RegisteredClient pkceClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .tokenSettings(TokenSettings.builder()
                        ...
                        .build())
                .build();
        return new InMemoryRegisteredClientRepository(clientCredentialClient, opaqueTokenClient, authCodeClient, pkceClient);
    }
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> jwtTokenCustomizer() {
        return (context) -> {
                if (context.getTokenType().equals(OAuth2TokenType.ACCESS_TOKEN)) {
                    context.getClaims().claim("system-name", "auth-server");
