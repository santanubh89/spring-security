...
ALTER TABLE authorities
    ADD CONSTRAINT FK_AUTHORITIES_ON_CUSTOMER FOREIGN KEY (customer_id) REFERENCES customer (customer_id);


insert into authorities (name, customer_id) values ('ADMIN', 1);
insert into authorities (name, customer_id) values ('USER', 1);