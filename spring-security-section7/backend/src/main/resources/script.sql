...
insert into authorities (customer_id, name) values (1, 'READ::ACCOUNTS');
insert into authorities (customer_id, name) values (1, 'READ::LOANS');
insert into authorities (customer_id, name) values (1, 'READ::CARDS');
insert into authorities (customer_id, name) values (1, 'READ::BALANCE');
